        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/fastfood.png" alt=""> </a>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rs. 1,000</a> </li>
                ...
                <div class="container">
                    ...
                    <!-- <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="images/fastfood.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    ...
                    <div class="row bottom-footer">
                        <div class="container">
                            ...
                            <h5>Address</h5>
                            <p>Near Asian Mall,
                            Bus-Stand, Hanamkonda</p>
                            <h5>Phone: <a href="tel:">9182404290</a></h5>
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <a href="#"> <img src="images/lock.png" alt="Image not avaliable for preview" > </a>
                        </div>
                        </div>
                    </div>
                    <!-- bottom footer ends -->
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs. 120</span></div>
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs. 250</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs. 310</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs. 220</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
