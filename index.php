...
<head>
    ...
    <link rel="icon" href="#">
    <title>FastFoood: online food ordering</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark" >
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/fastfood.png" alt=""> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/try.jpeg">
            ...
            <div class="container">
                ...
                <div class="bottom-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 payment-options color-gray">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-white">
                            <h5>Address</h5>
                            <p>Near Asian Mall,
